...
#define USR_DRIVER_USART_CMD_SET_PARAMETER      0x01
#define USR_DRIVER_USART_CMD_SET_BUFFER         0x02
#define USR_DRIVER_USART_CMD_FLUSH              0X03
#define USR_DRIVER_USART_CMD_STOP               0x04

struct usr_driver_usart_config
{
    const char *name;
...
struct usr_driver_usart_parameter
{
...
struct usr_driver_usart_buffer
{
    rt_uint8_t *send_buf;
    int send_bufsz;
    rt_uint8_t *read_buf;
...
struct usr_driver_usart
{
    ...
    struct usr_driver_usart_parameter parameter;
    const struct usr_driver_usart_config *config;
    rt_slist_t slist;
};
